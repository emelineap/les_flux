	...
	<?php
		...
		dynamic_sidebar( 'edge_footer_options' );
			...
			<a title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" target="_blank" href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php echo get_bloginfo( 'name', 'display' ); ?></a> | 
							<?php esc_html_e('Designed and developed by','Émeline Ancel-Pirouelle'); ?> <a title="<?php echo esc_attr__( 'Theme by Émeline Ancel-Pirouelle' ); ?>" target="_blank" href="<?php echo esc_url( 'http://www.emelineancelpirouelle.com' ); ?>"><?php esc_html_e('Émeline Ancel-Pirouelle');?></a> |

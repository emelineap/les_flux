...
?>
	...
	<div class="row row-last-posts">
		...
		<article class="one-post col-xs-12 col-lg-3" id="post-<?php the_ID(); ?>" <?php post_class();?>>
			<?php
			...
			<header class="entry-header">
				<h4 class="entry-title"> <a href="<?php the_permalink(); ?>" title="<?php the_title_attribute();?>"> <?php the_title();?> </a> </h4> <!-- end.entry-title -->
